...
void Class_Cargo_List::Add_Cargo(Enum_Cargo_Type Cargo_Type, Enum_Cargo_Floor Cargo_Floor, uint8_t Position_X, uint8_t Position_Y, uint8_t* Phone_Number, uint8_t* Code)
{
    //如果已经存在该货物 则不添加
