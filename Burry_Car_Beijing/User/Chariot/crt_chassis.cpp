...
//    //直接读取IMU yaw姿态
    ...
    #elif defined(NEW_CAR)
    float motor2_temp_rad = -Motor[0].Get_Now_Speed();
    float motor1_temp_rad = Motor[1].Get_Now_Speed();
    float motor4_temp_rad = Motor[2].Get_Now_Speed();
    float motor3_temp_rad = -Motor[3].Get_Now_Speed();      
    #endif
